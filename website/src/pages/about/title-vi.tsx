      ...
      <Navbar>
        ...
        <Container maxW={"2xl"} centerContent>
          <Text mt={5} textAlign={"center"}>
            ...
            subjected to discrimination under any of our programs and
            activities, as provided by Title VI of the Civil Rights Act of 1964,
            the Civil Rights Restoration Act of 1987, and all other related
          ...
          <Text mt={5} textAlign={"center"}>
            ...
            Civil Rights Act. Any person who believes she or he has been
            aggrieved by any unlawful or discriminatory practice under Title VI
            may follow a complaint with AppalCART, the public transportation
            authority serving Boone and all of Watauga County.
          </Text>

          <Text mt={5} textAlign={"center"}>
            For more information on AppalCART&#39;s Title VI program and the
            procedures to file a complaint, contact the Transportation Director
            at 828.297.1300 extension 104. You may also email the Transportation
          ...
          <Text mt={5} textAlign={"center"}>
            ...
            27699-1511; phone 919.508.1830 or toll-free 800.522.0453. A
            complaint may also be filed directly with the Federal Transit
            Administration by filing a complaint with the office of Civil
            Rights, Attention: Title VI Coordinator, East Building, 5th Floor -
            TCR, 1200 New Jersey Ave, SE, Washington, DC 20590.
          </Text>

          <Text mt={5} textAlign={"center"}>
            A complaint must be filed in writing within 180 days of the alleged
            discriminatory act. A complaint form is listed in the appendix of
            our Title VI plan (linked at the bottom) or by requesting one by
            emailing, calling, or writing the Transportation Director as listed
            above.
          </Text>
          ...
          <Text mt={5} textAlign={"center"}>
            ...
            written language services, and translations of vital documents for
            the purpose of using our transit system.
          </Text>

          <Center height={"fit-content"} mt={5}>
            <Grid templateColumns="repeat(4, 1fr)">
              <GridItem colSpan={2}>
                <NextLink href={"/Title-VI-Plan.pdf"} target={"_about"}>
                  <VStack>
                    <Image
                      boxSize="100px"
                      objectFit="cover"
              ...
              <GridItem colSpan={2}>
                <NextLink
                  href={"/Title-VI-Complaint-Form.pdf"}
                  target={"_about"}
                >
                  <VStack>
                    <Image
